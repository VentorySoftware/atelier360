...
CREATE TABLE public.message_templates (
  id VARCHAR NOT NULL DEFAULT public.generate_formatted_id('MT', 'public.message_templates_seq') PRIMARY KEY,
  name TEXT NOT NULL,
...
FOR EACH ROW
EXECUTE FUNCTION public.generate_formatted_id('MT', 'public.message_templates_seq');
